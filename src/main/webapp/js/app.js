    ...
    * */
    ...
    $nextBtn.addEventListener('click', function () {
        ...
        if($batchEnded) {
            ...
            $url.value = " -_-!! NO url in buffer";
            $nextBtn.value = "Please submit";
        }
    });
    ...
    $confirmBtn.addEventListener('click', function () {
        ...
        if(!$batchEnded){
            ...
            alert("Completed this round.Please submit");
        }
    ...
    function get_data () {
        ...
        xmlhttp.open("GET", "/lasagnaTagging/handle-data",true);
        xmlhttp.send();
    }
    ...
    function send_back_to_server () {
        ...
        xmlhttp.open("POST", "/lasagnaTagging/handle-data", true);
